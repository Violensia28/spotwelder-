...
#include <pgmspace.h>
#include <stdio.h>
#include "buildver_fix_autoshim.h"  // keep BUILD_VERSION as string

// extern globals (must be defined in your main.cpp or core files)
...
// Optional auto-register (if you don't want to touch main.cpp)
